...
# $2-$6: Output files, to specify:
#     instruction count, mem accesses, hits, misses and order of traces
            ...
            for file in files:
                with open(file) as f:
                    if file.endswith(".packet.classified_mem_trace"):
                        ...
                        dup_file = file.replace(
                            'classified_mem_trace', 'duplicated')
