...
do 
  ...
  python $KLEE_DIR/scripts/contract-tree/build_tree.py tc_tags combined_perf.txt perf-formula.txt "$METRIC" $TREE_FILE $TREE_TYPE $RESOLUTION perf_var_$METRIC_NAME formula_var_$METRIC_NAME 
done
